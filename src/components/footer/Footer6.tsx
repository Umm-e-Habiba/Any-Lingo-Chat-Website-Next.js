        ...
        <div className="relative z-10 pt-[73px] 2xl:pt-[103px]">
          ...
          <div>
            <div className="mb-[34px]">
              <h2
                className={cn(
                  "leading-none text-text-fixed-2 text-[35px] md:text-[40px] lg:text-[70px] xl:text-[100px] 2xl:text-[120px] -mt-2 md:-mt-[9px] lg:-mt-[17px] xl:-mt-[25px] has_fade_anim inline me-[22px]",
                  TitleClassName
                )}
                dangerouslySetInnerHTML={convertWithBrSpan(title)}
              />
              <div className="flex xl:inline-flex lg:translate-y-[-25px] mt-[25px] xl:mt-0">
                <ButtonSwap
                  link="/contact"
                  bgColor={"bg-theme"}
            ...
            <div className="mt-[18px]">
              <p className="has_fade_anim text-[18px] md:text-[26px] xl:text-[32px] 2xl:text-[36px] max-w-[850px] text-text-fixed-3 font-light">
                {subtitle}
              </p>
            </div>
          </div>

          <div className="border-t border-[#ffffff14] mt-10 md:mt-[50px] 2xl:mt-[60px] py-[39px] md:py-[59px] 2xl:py-[79px] grid gap-y-[30px] gap-x-10 xl:gap-x-[120px] md:grid-cols-[150px_150px_1fr] lg:grid-cols-[190px_190px_1fr]">
